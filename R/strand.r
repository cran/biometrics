#' Function of the Strand model, based
#' upon two parameters and a single predictor variable as
#' follows
#' \deqn{y_i= \left(\frac{x_i}{\alpha +\beta x_i}\right)^3,}
...
#' # Using the function
#' y<-strand.fx(x=time,alpha=1.15,beta=.37)
#' plot(time,y,type="l")
#'  
#' @rdname strand.fx
#' @export
#'
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
strand.fx <- function(x, alpha, beta, upsilon=0){
    upsilon+ (x/(alpha+beta*x))^3 
}
